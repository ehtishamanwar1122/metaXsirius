...
const About = () => {
  ...
  <div className="col-md-3 col-12  about-head  ">
    <h1 >About Us</h1>
  </div>
  <div className="col-md-9 col-12 about-body">
  <p className="text-md-start text-center">
    ...
    a seasoned investor or just starting your journey.
      ...
      <div className="row">
        <div className="col-md-9 col-12 d-flex justify-content-center mb-3">
          <img
            src={AboutImage1}
        ...
        <div className="col-md-3 col-12 d-flex justify-content-center">
          <img
            ...
            className="col-md-12 col-12 img-fluid rounded-start image-about"
          />
        </div>
      </div>
    </div>
